...
<body>
    ...
    $biodata = [
        ...
        'hobi' => 'Main game',
        'alamat' => 'Cangkuang',
        'email' => 'palenxaldi@Gmail.com',
        'sosmed' => [
            'instagram' => 'https://www.instagram.com/aldimulyana61?igsh=dHV0YXVhMGZnM3Rj',
            'github' => 'https://github.com/palenxaldi-abadi'
        ],
        'foto' => '../gambar/aldi.jpg' // Ganti dengan path foto asli
    ];
    ?>
